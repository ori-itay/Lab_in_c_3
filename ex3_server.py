...
def main():
    ...
    socket_server_one.connect('localhost', port)

    server_socket_server_two   = socket(AF_INET, SOCK_STREAM)
    socket_server_two.connect('localhost', port)

    server_socket_server_three = socket(AF_INET, SOCK_STREAM)
    socket_server_three.connect('localhost', port)

    socket_list = [socket_server_one, socket_server_three, socket_server_three]
    while True:
